...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='starnet_s1', help='the backbone name of EDN, vgg16, resnet50, or mobilenetv2')
    ...
    parser.add_argument('--pretrained', default="pretrained/model_46-starnet_s1.pth", help='Pretrained model')
