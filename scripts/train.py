...
def train_validate_saliency(args):
    ...
    trainLoader_main = torch.utils.data.DataLoader(
        Dataset(args.data_dir, 'DUTS-TR', transform=trainDataset_main),batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=False, drop_last=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ms', default=0, type=int) # normal multi-scale training
