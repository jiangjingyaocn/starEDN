...
def test(args, model, image_list, label_list, save_dir):
    ...
    for idx in tqdm(range(len(image_list))):
        ...
        # outputs_saliency, _, _ = model(img)
        # img_out = outputs_saliency[0]
        # print(type(img_out))
        # img_out = outputs_saliency[0, 0, :, :].unsqueeze(dim=0)
...
if __name__ == '__main__':
    ...
    if 'Lite' in args.pretrained:
        ...
        args.arch = 'p2t_small'
    elif 'starnet' in args.pretrained:
        args.arch = 'starnet_s1'
    else:
    ...
    data_lists = ['blockage','selectedall']
    # data_lists = ["DUTS-TE", "DUT-OMRON", "HKU-IS", "ECSSD", "SOD", "PASCAL-S"]
